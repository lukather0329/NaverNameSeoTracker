...
- Report filters added for status, judgement, and tracked window
...
2. Test report filters and confirm the table/CSV react to the selected filters.
3. Test both CSV downloads with seeded snapshot data.
